 ...
 * @author osraldo
 */
public class JPrintStudentForm extends javax.swing.JDialog {
    private int m_nPrimaryKey;
    /**
     * Creates new form JPrintStudentForm
     */
    public JPrintStudentForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jrdoRpt1 = new javax.swing.JRadioButton();
        jrdoRpt2 = new javax.swing.JRadioButton();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Print Student Form");
        setResizable(false);
        ...
        buttonGroup1.add(jrdoRpt1);
        jrdoRpt1.setMnemonic(KeyEvent.VK_R);
        jrdoRpt1.setSelected(true);
        jrdoRpt1.setText("Registration");

        buttonGroup1.add(jrdoRpt2);
        jrdoRpt2.setMnemonic(KeyEvent.VK_H);
        jrdoRpt2.setText("Schedule");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(jrdoRpt1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jrdoRpt2)
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jbntCancel, jbtnPrint, jbtnSearch});
    ...
    private void jbtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPrintActionPerformed
        shrs.reports.JEnrollStudentReport dlg = new shrs.reports.JEnrollStudentReport(m_nPrimaryKey);
        if(jrdoRpt1.isSelected()) {
            dlg.showEnrollmentForm();
        }
        else {
            dlg.showEnrollmentSubjects();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JPrintStudentForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JPrintStudentForm dialog = new JPrintStudentForm(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JRadioButton jrdoRpt1;
    private javax.swing.JRadioButton jrdoRpt2;
